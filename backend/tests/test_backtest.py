...
def test_normalize_component_score_clips_and_scales():
    ...
    assert main._normalize_component_score(-0.2, component) == 0.0
    assert main._normalize_component_score(0.25, component) == pytest.approx(0.5)
    assert main._normalize_component_score(0.8, component) == 1.0
